...
loadOne(github('history-core.js'),function(ok){if(!ok){try{console.log('REZKA4 history core unavailable')}catch(e){}return}loadOne(github('player-playlist-addon.js'),function(playlistOk){if(!playlistOk){try{console.log('REZKA4 player playlist layer unavailable')}catch(e){}return}loadOne(github('player-translator-fix.js'),function(fixOk){if(!fixOk)try{console.log('REZKA4 translator pin fix unavailable')}catch(e){}})})});
})();