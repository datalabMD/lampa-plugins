...
(function(){
'use strict';
var REV='R4-TRANS-0912-K';
if(window.rezka4_playlist_translator_fix_rev===REV)return;
window.rezka4_playlist_translator_fix_rev=REV;
window.rezka4_playlist_translator_fix=true;
...
/* Runtime probe for TV: if this layer is current, Play becomes red and a notice appears. */
try{
 var sid='rezka4-translator-probe-style',old=document.getElementById(sid);if(old)old.remove();
 var st=document.createElement('style');st.id=sid;st.textContent='.player-panel__center .player-panel__playpause{background:#ff1744!important;border-color:#ff1744!important;box-shadow:0 0 0 .12em rgba(255,23,68,.35)!important}.player-panel__center .player-panel__playpause svg{fill:#fff!important;color:#fff!important}';
 (document.head||document.documentElement).appendChild(st);
 var tries=0;(function hook(){try{if(typeof Lampa!=='undefined'&&Lampa.Player&&Lampa.Player.listener){if(window.rezka4_translator_probe_hook!==REV){window.rezka4_translator_probe_hook=REV;Lampa.Player.listener.follow('start',function(){try{Lampa.Noty.show(REV+' LIVE')}catch(e){}})}return}}catch(e){}if(tries++<40)setTimeout(hook,250)})();
}catch(e){}
})();