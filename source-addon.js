...
(function () {
    ...
    function injectStyles() {
        ...
        style.textContent = [
            ...
            '.rezka4-ui.r4-grid{display:grid!important;grid-template-columns:repeat(10,minmax(0,1fr))!important;gap:.55em!important;overflow-y:auto!important;padding-bottom:3em!important}',
            '.rezka4-ui.r4-grid .rezka4-hero{grid-column:1/-1;margin-bottom:.15em!important}',
            '.rezka4-ui.r4-grid .rezka4-card{margin:0!important;min-height:4.6em!important;padding:.78em .65em .72em .78em!important;display:flex!important;flex-direction:column!important;align-items:flex-start!important;justify-content:center!important;gap:.12em!important}',
            '.rezka4-ui.r4-grid .rezka4-card>div:first-child{width:100%!important}',
            '.rezka4-ui.r4-grid .rezka4-main{font-size:.9em!important;white-space:normal!important;line-height:1.12!important}',
            '.rezka4-ui.r4-grid .rezka4-meta{font-size:.63em!important;margin-top:.24em!important;white-space:nowrap!important}',
            '.rezka4-ui.r4-grid .rezka4-badge{display:none!important}',
            '.rezka4-ui.r4-grid .rezka4-card.focus{transform:scale(1.075)!important}',
            '.rezka4-ui.r4-grid .rezka4-back{grid-column:1/-1!important;min-height:2.65em!important;max-width:18em!important;display:flex!important;flex-direction:row!important;align-items:center!important;justify-content:space-between!important;padding:.58em .9em .58em 1.05em!important}',
            ...
            '.rezka4-ui.r4-grid .rezka4-back .rezka4-badge{display:block!important;position:static!important}',
            '.rezka4-ui.r4-episodes .rezka4-card:not(.rezka4-back){min-height:4.15em!important;text-align:center!important;align-items:center!important}',
            '.rezka4-ui.r4-episodes .rezka4-card:not(.rezka4-back)>div:first-child{text-align:center!important}',
            '.rezka4-ui.r4-episodes .rezka4-card:not(.rezka4-back) .rezka4-main{font-size:.92em!important}',
            ...
            '@media (max-width:1100px){.rezka4-ui.r4-grid{grid-template-columns:repeat(8,minmax(0,1fr))!important}}'
        ].join('');
